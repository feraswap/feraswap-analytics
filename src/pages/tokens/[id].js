...
function TokenPage() {
  ...
  return (
    <AppShell>
      <Head>
        <title>
          {currencyFormatter.format(price || 0)} | {token.symbol} | FeraSwap
          Analytics
        </title>
      </Head>
      <PageHeader>
        ...
        >
          ...
          <Grid item xs={12} sm="auto" className={classes.links}>
            <Link
              href={`https://feraswap-dev.bitfera.com/add/${token.id}/ETH`}
              target="_blank"
              variant="body1"
            >
              Add Liquidity
            ...
            <Link
              href={`https://feraswap-dev.bitfera.com/swap?inputCurrency=${token.id}`}
              target="_blank"
              variant="body1"
            >
              Trade
      ...
      <Box my={4}>
        <BasicTable
          ...
          bodyCells={[
            ...
            token.symbol,
            token.id,
            <Link href={`https://kovan.etherscan.io/address/${token.id}`}>View</Link>,
          ]}
        />
      </Box>

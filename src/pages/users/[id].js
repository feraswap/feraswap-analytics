...
function UserPage() {
  ...
  const {
    ...
    variables: {
      id: "0x40da37cabcaab2a9c580a1d5b479fa4a098c754f",
    },
  });
  ...
  return (
    <AppShell>
      <Head>
        <title>User {id} | FeraSwap Analytics</title>
      </Head>
                      ...
                      <Box display="flex" alignItems="center">
                        <Avatar
                          ...
                          src={`https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/ethereum/assets/${toChecksumAddress(
                            "0x40da37cabcaab2a9c580a1d5b479fa4a098c754f"
                          )}/logo.png`}
                        />
                        <Link
                          href={`/tokens/0x40da37cabcaab2a9c580a1d5b479fa4a098c754f`}
                          variant="body2"
                          noWrap
                        >
                          FERA
